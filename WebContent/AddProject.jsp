					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-header">
								<strong>Project</strong><small> Detail</small>
							</div>
								...
								<form action="SaveProjectServlet" method="post">
									<div class="form-group">
										<label for="company" class=" form-control-label">Title</label><input
											...
											placeholder="Enter your project title" class="form-control">
									</div>
									<div class="form-group">
										<label for="vat" class=" form-control-label">Technology</label><input
											type="text" id="vat" placeholder="Enter Technology"
											class="form-control">
									</div>
